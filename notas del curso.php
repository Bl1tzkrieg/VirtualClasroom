        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              ...
              <p>Sigue mas de cerca el progreso de tus Alumnos...</p>
            </div>
          </div>
        </div>
      </div> 
                    ...
                    <div class="row">
                      ...
                      //se busca las clases de la ci en sesion
                        ...
                        if($r>0){
                          ...
                          $consultanotaz="SELECT * FROM tarea WHERE idClase='$temporal'"or die("Error en la consulta" . mysqli_error($link));
                          ...
                          while ($columna2 = mysqli_fetch_array($resultado2)){
                             ...
                             while($columna3 = mysqli_fetch_array($resultado3)){
                              if($columna3['valor'] != NULL){
                                $not=$columna3['valor'];
                                $u="notas del curso.php";
                                $asig=$datos['asignatura'];
                                $a=$aux;
                                $b=$columna3['idEvaluacion'];
                                echo "<td align='center'>" . "<a href='viewN.php?asignatura=$asig&clase=$a&evaluacion=$b&c=$cedula&ubica=$u' > $not </a>" . "</td>";
                              }
                              else{
