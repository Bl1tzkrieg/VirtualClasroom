    ...
    <div class="site-section">
        <div class="container">
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                          <label class='row justify-content-center' for="username">New Password</label>
                            <input name="new" type="text" id="nombre" class="form-control form-control-lg" required>
                            </div>
                    </div>


                    <div class="col-md-12 form-group">
                            <label class='row justify-content-center' for="pword">Password actual para confirmar</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input name="actuPass" type="submit" value="Guardar Cambios" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <?php
                if(isset($VA1)){
                  if($VA1=="e"){
                  echo "<p class='row justify-content-center'> Se han Guardado los Cambios </p>";
                 }

                 else if($VA1=="x"){
                  echo "<p class='row justify-content-center'>Password es Invalido</p>";
                 }
               }
                ?>
        </div>
