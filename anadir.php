...
<head>
  <title>Añadir Intregantes</title>
  <meta charset="utf-8">
  ...
  <div class="site-section ftco-subscribe-1 site-blocks-cover pb-7" style="background-image: url('images/registro.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0"> Añadir Intregantes</h2>
              <p>Opcion para añadir integrantes a su clase virtual</p>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="container">
       ...
       <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current">Añadir integrantes</span>
      </div>
    </div>
  </div>
...
<form action="escribirRegistro.php" method="POST">
    <div class="site-section">
        ...
        if(isset($VA1)){
           if($VA1==1){
                echo "<p class='row justify-content-center'>El usuario ya se encuentra asignado a este curso</p>";
          }

           else if($VA1==2){
                echo "<p class='row justify-content-center'>El alumno se guardó Correctamente</p>";
          }
          else if($VA1==3){
        ...
        ?>
         ...
         <div class="row mb-5 justify-content-center text-center">
                ...
                <div class="col-md-5">
                    <div class="row">
                      <div class="col-md-12 form-group">
                           ...
                           <select name="idCurso" id="genero" class="form-control form-control-lg">
            ...
            ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input name="anadir" type="submit" value="Añadir" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </div>
                </div>
