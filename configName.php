  ...
  ?>   
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Datos Personales</span>
      </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    <div class="col-md-12 form-group">
                            <label for="pword">Introduzque su Password para confirmar</label>
                            <input name="pass" type="password" id="pword" class="form-control form-control-lg" required>
                        </div>
                     <div class="row mb-5 justify-content-center text-center">   
                    <div class="row">
                        <div class="col-12">
                            <input name="actuName" type="submit" value="Guardar Cambios" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </div>
                </div>
