        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              ...
              <p>Portal para visualizar una lista de sus actividades asignadas</p>
            </div>
          </div>
        </div>
      </div> 
        ...
        <div class="container">
         ...
         <div class="row mb-5 justify-content-center text-center">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-5">
                    <div class="row">
                      ...
                      <input type="hidden" name="ubica" value="tareas asignadas.php">
            ...
            ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input name="portal" type="submit" value="consultar" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </div>
                </div>
