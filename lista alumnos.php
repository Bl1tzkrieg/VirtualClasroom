                    ...
                    <div class="row">
                      ...
                      $ci= $_SESSION['sessionCI'];
                        ...
                        if($r>0){
                          ...
                          $aux = "SELECT * FROM clases WHERE idClase='$VA1'" or die ("Error en la consulta" . mysqli_error($link));

                          $sql= $conection -> query($aux);

                          $data= $sql->fetch_assoc();

                          $consulta2= "SELECT * FROM alumno_has_clases WHERE idClase='$VA1'" or die ("Error En la Consulta" . mysqli_error($link));

                          $sql2= $conection -> query($consulta2);



                        while ($columna = mysqli_fetch_array($sql2)){
                          
                           $cedula=$columna['ci'];
                          $sql3 = "SELECT * FROM persona WHERE ci='$cedula'";
                          $res= $conection -> query($sql3);
