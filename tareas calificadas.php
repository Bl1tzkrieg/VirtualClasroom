  ...
  ?>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/course_2.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Asignaciones Calificadas</h2>
              <p>¡Puedes observar las notas de tus alumno! </p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Asignacion</span>
      </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h2 class="section-title-underline mb-5">
                              <span>Tabla de Actividades Evaluadas</span>
                            </h2>
                           </div>
                      <?php      
                      ...
                      //se busca las clases de la ci en sesion
                        ...
                        $temp=0;
                          ...
                          $name=$datos['asignatura'];
						              $idCurso=$datos['idClase'];

                          


                          $consulta2 = "SELECT * FROM nota WHERE idClase='$temporal' AND ci='$VA2'" or die("Error en la consulta" . mysqli_error($link));


                          $resultado2 = mysqli_query($conection,$consulta2) or die ("Hay algo mal en la tabla");
			  
			    $alumno = "SELECT * FROM persona WHERE ci ='$VA2'";
                            $alumnoNames = $conection ->query ($alumno);
                            $nombresAlumno = $alumnoNames ->fetch_assoc();
			    $NombreDeEstudiante = $nombresAlumno['nombre'] . " " . $nombresAlumno['apellido'];
                          
                                echo "<h3 class='row mb-1 justify-content-center text-center'> $name (ID $idCurso)</h3>";
                                echo "<h3 class='row mb-5 justify-content-center text-center'> $NombreDeEstudiante (CI $VA2)</h3>";
                          ...
                          while ($columna2 = mysqli_fetch_array($resultado2)){
                            ...
                            if($columna2['ruta']!=null && $columna2['valor']!=NULL || $columna2['respuesta']!=null && $columna2['valor']!=NULL){
                             ...
                             echo "<td align='center'>" . $columna2['valor'] . "</td>";
                            
                             
                             $asigna= $datos['asignatura'];
                             $eval= $columna2['idEvaluacion'];
                             $cali="calificadas";
 
                               echo "<td align='center'>" . "<a href='viewN.php?asignatura=$asigna&clase=$temporal&calificada=$cali$ciAlumno&evaluacion=$eval&c=$ciAlumno&ubica=tareas calificadas.php?/=$idCurso' class='small btn btn-primary px-2 py-2 rounded-0' ><span class='icon-paperclip'></span> Ver Actividad</a>" . "</td>"; 
