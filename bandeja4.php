            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row">
                      ...
                      //se busca las clases de la ci en sesion
                        $consulta = "SELECT * FROM sugerencia" or die("Error en la consulta" . mysqli_error($link));
                        ...
                        while ($columna = mysqli_fetch_array($resultado)){
                            ...
                            ?>
                             ...
                             echo "<td align='center'>" . $columna['id'] . "</td>";
 
                             $id=$columna['id'];
                            
                            if($columna['view']=="si"){
                              echo "<td align='center'>" . "<a href='bandejaMaster.php?sugerencias=$id' class='small btn btn-primary px-2 py-2 rounded-0' ><span class='icon-envelope-open'></span> Visto </a>" . "</td>";
                             }
                             else{
                              echo "<td align='center'>" . "<a href='bandejaMaster.php?sugerencias=$id' class='small btn btn-primary px-2 py-2 rounded-0' ><span class='icon-envelope'></span>Nuevo</a>" . "</td>";
                             }


                             echo "<td align='center'>" . "<a href='escribirRegistro.php?sugerencias=$id' class='small btn btn-primary px-2 py-2 rounded-0' ><span class='icon-trash'></span>Borrar </a>" . "</td>";
