   ...
   <form id="soporte" action="escribirRegistro.php" method="POST">
     <div class="site-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <input  name="preguntas" type="submit" value="enviar" class="btn btn-primary btn-lg px-5">
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        if(isset($_GET['/'])){
           if($_GET['/']==1){
                echo "<p class='row justify-content-center'>Su Pregunta se ha enviado con exito</p>";
          }
        }
        ?>
