    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-7" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0"> Foto de Perfil</h2>
              <p>Ya Puedes Personalizar Su foto de perfil</p>
            </div>
          </div>
        </div>
      </div> 
        ...
        <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                           ...
                           <div class="row mb-5 justify-content-center text-center">
                            ...
                            <input name="foto" type="file" accept=".jpg , .png" required/>
                            

                            <br>
                            <br>
                            <div class="row mb-5 justify-content-center text-center">
                            <input name="perfil" type="submit" value="Guardar" class="btn btn-primary btn-lg px-5">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php
                ...
                if(isset($VA1)){
                  ...
                  echo "<p class='row justify-content-center'>Ocurrio un error, intente nuevamente</p>";
                 }
               }
                ?>
