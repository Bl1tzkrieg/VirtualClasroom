  ...
  ?>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/registro.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              <h2 class="mb-0">Registro Estudiante</h2>
              <p>Solo tú tienes el gran potencial para adquirir mas conocimimiento</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <?php
        if(isset($VA1)){
           ...
           if($VA1==2){
                echo "<p class='row justify-content-center'>Se ha Registrado en el Sistema</p>";
          }
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                      ...
                      <div class="col-md-12 form-group">
                          ...
                          <div class="col-md-12 form-group">
                            ...
                            <input name="ci" type="number" id="ci" class="form-control form-control-lg" required>
                          </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input name="estudiante" type="submit" value="Registrar" class="btn btn-primary btn-lg px-5">
                        </div>
                        </div>
                    </div>
                </div>
