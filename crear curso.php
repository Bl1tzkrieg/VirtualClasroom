  ...
  <div class="site-section ftco-subscribe-1 site-blocks-cover pb-7" style="background-image: url('images/registro.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0"> Crear Curso</h2>
              <p>Ahora puedes crear tus cursos de forma rapida y sencilla</p>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="container">
       ...
       <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current">Crear Cursos</span>
      </div>
    </div>
  </div>
...
<form action="escribirRegistro.php" method="POST">
   ...
   <?php
        if(isset($VA1)){
           ...
           if($VA1==1){
                echo "<p class='row justify-content-center'>Introduzca otra ID para su clase, La que Introdujo ya se encuentra en la base de datos</p>";
          }

          if($VA1==2){
                echo "<p class='row justify-content-center'>Se ha Creado el Curso</p>";
          }
        }
        ?>
                      ...
                      $ci= $_SESSION['sessionCI'];
                        ...
                        while ($columna = mysqli_fetch_array($resultado)){
                         ...
                         <li>
                          <?php
                         echo "<td>" . $datos2['asignatura'];
                         echo  "   (ID    " . $columna['idClase'] . ")";
                          ?>
                         </li>
                         <?php
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-5">
                    <div class="row">
                            ...
                            <label for="username">Asignatura</label>
                            <input name="asignatura" type="text" id="apellido" class="form-control form-control-lg" required>
                          	</div> 
                    </div>
                    <div class="row mb-5 justify-content-center text-center">
                    <div class="row">
                        <div class="col-12">
                            <input name="crearCurso" type="submit" value="Crear" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </div>
                </div>
