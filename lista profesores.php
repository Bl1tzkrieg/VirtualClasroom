  ...
  ?>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/course_2.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Instructores</h2>
              <p>Aquí puedes visualizar una lista de todos los Instructores</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Lista de Instructores</span>
      </div>
    </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row">
                      ...
                      $ci= $_SESSION['sessionCI'];
                        $consulta = "SELECT * FROM profesor" or die("Error en la consulta" . mysqli_error($link));
