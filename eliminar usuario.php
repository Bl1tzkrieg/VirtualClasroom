  ...
  <div class="site-section ftco-subscribe-1 site-blocks-cover pb-7" style="background-image: url('images/registro.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Eliminar</h2>
              <p>Opcion para eliminar Usuarios</p>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="container">
       ...
       <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current">Eliminar Usuario</span>
      </div>
    </div>
  </div>
...
<form action="escribirRegistro.php" method="POST">
    <div class="site-section">
        <div class="container">
         ...
         <div class="row mb-5 justify-content-center text-center">
            <h2 class="section-title-underline mb-5">
              <span>Eliminar Usuario del Sistema</span>
            </h2>
          </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input name="elimina_user" type="submit" value="Eliminar" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </div>
        ...
        if(isset($VA1)){
           if($VA1==1){
                echo "<p class='row justify-content-center'>Los Cambios se Guardaron correctamente</p>";
          }
