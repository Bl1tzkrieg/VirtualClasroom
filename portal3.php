...
<!--  <link href="https://fonts.googleapis.com/css?family=Muli:300,400,700,900" rel="stylesheet"> -->
  ...
  <script type="text/javascript">
    function changeFunc($i){
     window.location.replace("portal3.php?l="+$i);
    }
  </script>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-5">
                    <div class="row">
                      ...
                      <input type="hidden" name="ubica" value="tareas calificadas.php">

                      <div class="col-md-12 form-group">
                           <label for="username"> Seleccione </label>
                           <select name="idCurso" id="genero" onchange="changeFunc(value)"; class="form-control form-control-lg" required>
