            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row">
                      ...
                      //se busca las clases de la ci en sesion
                        $consulta = "SELECT * FROM soporte" or die("Error en la consulta" . mysqli_error($link));
                        ...
                        while ($columna = mysqli_fetch_array($resultado)){
                            ...
                            if($columna['view']=="si"){
                              echo "<td align='center'>" . "<a href='bandejaMaster.php?soporte=$id&email=$email&nombre=$nombre' class='small btn btn-primary px-2 py-2 rounded-0' ><span class='icon-envelope-open'></span> Visto </a>" . "</td>";
                             }
                             else{
                              echo "<td align='center'>" . "<a href='bandejaMaster.php?soporte=$id&email=$email&nombre=$nombre' class='small btn btn-primary px-2 py-2 rounded-0' ><span class='icon-envelope'></span>Nuevo</a>" . "</td>";
                             }


                             echo "<td align='center'>" . "<a href='escribirRegistro.php?soportes=$id&nombre=$nombre&email=$email' class='small btn btn-primary px-2 py-2 rounded-0' ><span class='icon-trash'></span>Borrar </a>" . "</td>";
