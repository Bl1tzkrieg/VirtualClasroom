        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              ...
              <p>Aquí puedes observar los detalles de la asignacion</p>
            </div>
          </div>
        </div>
      </div> 
           	...
           	<div class="row">
               	<div class="col-12">
                  	<div class="col-md-12 form-group">
                      	<label for="username">Ingrese su calificación</label>
                       	<input name="nota" type="number" id="nombre" class="form-control form-control-lg" required>
                   	</div>        
                    <div class="row">
                       	<div class="col-12 justify-content-center text-center">
                        	<input name="calificar" type="submit" value="Calificar" class="btn btn-primary btn-lg px-5">
                    	</div>
                	</div>                  
           		</div>
        	</div>
