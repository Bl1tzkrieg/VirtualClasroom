            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                           ...
                           <p style="color: red">¡Advertencia! La nota definitiva es inmodificable.</p>

                           </div>

                           <div class="col-md-12 form-group">
                          <label for="username">Ingrese la nota</label>
                            <input name="notaDef" type="number" id="nombre" class="form-control form-control-lg" required>
                            </div>
                    ...
                    <div class="row mb-5 justify-content-center text-center">
                            <div class="row">
                           <div class="col-12">
                            <input name="definitiva" type="submit" value="Asignar" class="btn btn-primary btn-lg px-5">
                             </div>
                             </div>
                    </div>
                        </div>
